...
class AIRoot{
	 ...
	 * 返回信息
	 */
	public function set onMessage(f:Function){
		_onmessage = f;
	}
	
	public function set onOpen(f:Function){
		_onopen = f;
		
	}
	
	public function set onClose(f:Function){
		_onclose = f;
	}
	
	public function set onError(f:Function){
		_onerror = f;
	}
